...
public class SnakeManager : MonoBehaviour
{
    ...
    public void ResetSnake()
    {
        ...
        // Reinicia la direcci?n y posici?n de la cabeza
    ...
    void Grow()
    {
        // Instancia un nuevo segmento y posici?nalo en el lugar adecuado
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        if (collision.CompareTag("Food"))
        {
            AddPoint();
            food.Eaten();
            Grow(); // Incrementa el tama?o de la serpiente
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        {
            Debug.Log("Game Over");
            Time.timeScale = 0; // Det?n el juego
        }
    }
